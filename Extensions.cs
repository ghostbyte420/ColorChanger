...
namespace ColorChanger.Extensions
{
            ...
            for (int k = 0; k < resultBuffer.Length; k += 4)
            {
                ...
                if (sourceAlpha != 0)
                {
                    ...
                    if ((sourceBlue < blueFilter + filterData.ThresholdValue && sourceBlue > blueFilter - filterData.ThresholdValue) &&
                        ...
                        (sourceRed < redFilter + filterData.ThresholdValue && sourceRed > redFilter - filterData.ThresholdValue))
                    {
    ...
    {
        public static Image MirrorImage(Image image, bool flipHorizontally, bool flipVertically)
        {
